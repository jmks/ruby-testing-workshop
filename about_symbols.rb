...
class AboutSymbols < Neo::Koan
  ...
  # strings are not symbols? (see line 30)
  ...
  in_ruby_version("mri") do
    ...
    # the constant name becomes a symbol, not the value of the constant
  end
  ...
  # symbols are immutable so once created exist until the interpreter exits
end
